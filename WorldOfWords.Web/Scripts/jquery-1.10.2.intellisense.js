...
intellisense.annotate(jQuery.fn, {
  ...
  'on': function() {
    ...
    ///   <param name="data" type="Anything">WorldOfWordsData to be passed to the handler in event.data when an event is triggered.</param>
    ...
    ///   <param name="data" type="Anything">WorldOfWordsData to be passed to the handler in event.data when an event occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
